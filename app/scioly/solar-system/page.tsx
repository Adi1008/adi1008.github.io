...
const linkClass =
  'underline decoration-zinc-300 underline-offset-2 hover:decoration-zinc-500 dark:decoration-zinc-600'

export default function SolarSystem() {
  return (
    <main>
      <h1 className="mb-6 text-lg font-medium">Solar System</h1>
      <div className="space-y-4 text-zinc-600 dark:text-zinc-400">
        <p>
          Solar System is a Division B event focused on habitability within and
          beyond the Solar System. This event is meant to be highly
          interdisciplinary, drawing on concepts from astronomy, planetary
          science, geology, chemistry, and biology, among others.
        </p>

        <h2 className="pt-4 font-medium text-zinc-900 dark:text-zinc-100">
          Official Webinar
        </h2>
        <p>
          The A-Team typically produces a webinar to help students get a feel
          for the content and question styles that will be emphasized in their
          events, particularly at the national level. The Solar System webinar
          for the 2022-2023 competition season can be found below.
        </p>
        <div className="overflow-hidden rounded-2xl ring-1 ring-zinc-200/50 ring-inset dark:ring-zinc-800/50">
          <iframe
        ...
        <ul className="list-disc space-y-1 pl-5">
          ...
          <li>
            <a className={linkClass} href="https://photojournal.jpl.nasa.gov/">
              JPL Photojournal
            </a>
          </li>
        </ul>
        ...
        <p>
          Once you have a good grasp of the basics, you can start to delve into
          more advanced topics. In particular,{' '}
          <em>A Student&rsquo;s Guide to the Mathematics of Astronomy</em> has
          some of the best material I have ever seen for solidifying your
          intuition for the underlying math and physics in this event.
        </p>
        <ul className="list-disc space-y-1 pl-5">
          <li>
          ...
          <li>
            <em>Fundamental Planetary Science</em> by Jack J. Lissauer (2019)
          </li>
          <li>
            <em>Astrobiology: An Introduction</em> by Alan Longstaff (2015)
          </li>
          <li>
            <em>A Student&rsquo;s Guide to the Mathematics of Astronomy</em> by
            Daniel Fleisch and Julia Kregenow (2013)
          </li>
        </ul>
      </div>
    </main>
