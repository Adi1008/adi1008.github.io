...
export default function Scioly() {
  return (
    <main>
      <h1 className="mb-6 text-lg font-medium">Science Olympiad</h1>
      <div className="space-y-4 text-zinc-600 dark:text-zinc-400">
        <p>
          <a className={linkClass} href="https://www.soinc.org/">
            Science Olympiad
          </a>{' '}
          is the nation&apos;s largest team-based science competition. Teams of
          students compete in events ranging from anatomy and astronomy to
          engineering challenges. I competed in Science Olympiad for six years
          at{' '}
          <a
            className={linkClass}
        ...
        <p>
          ...
          that runs the astronomy-related events in Science Olympiad. In the
          past, we have been generously supported by{' '}
          <a className={linkClass} href="https://www.universe-of-learning.org/">
        ...
        <p>
          ...
          , I serve as the National Event Supervisor for Solar System and Reach
          for the Stars, which rotate every two years. We make the rules,
          create educational resources, and run these events at the National
          Tournament every May. For the 2025-2026 competition season, the event
          is <strong className="font-medium">Solar System</strong>.
        </p>
        <p>
          ...
          , or any other member of the A-Team you may know. We&apos;d love to
          have you!
        </p>
      </div>
      <div className="mt-10 grid grid-cols-1 gap-6 sm:grid-cols-2">
        {[
          ...
          <Link
            key={card.href}
            href={card.href}
            className="group overflow-hidden rounded-2xl bg-zinc-50/40 ring-1 ring-zinc-200/50 ring-inset dark:bg-zinc-950/40 dark:ring-zinc-800/50"
          >
            <img
              src={card.image}
              alt={card.alt}
            ...
            />
            <p className="p-4 font-medium text-zinc-900 dark:text-zinc-100">
              {card.title} →
            </p>
          </Link>
        ))}
