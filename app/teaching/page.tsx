...
export default function Teaching() {
  return (
    <main>
      <h1 className="mb-6 text-lg font-medium">Teaching</h1>
      <div className="space-y-4 text-zinc-600 dark:text-zinc-400">
        <p>
          I really enjoy teaching. It helps me understand the material better,
          and it forces me to be intentional about explaining concepts clearly
          and concisely. And above all, working with students and helping them
          grow feels meaningful and fulfilling in a way that few other jobs do.
        </p>
        <p>
          ...
          experiences, and I&apos;m grateful to have been awarded the Chemical
          Engineering department&apos;s Outstanding TA Award and the
          university-wide{' '}
          <a
            className={linkClass}
        ...
        <p>
          ...
          <a className={linkClass} href="/files/course-evals/chemeng110b.pdf">
            CHEMENG 110B
          </a>{' '}
          and{' '}
          <a className={linkClass} href="/files/course-evals/chemeng340.pdf">
            CHEMENG 340
          </a>
          .
        </p>
