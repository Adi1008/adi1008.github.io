...
- `app/page.tsx` — homepage (About me)
- `app/data.ts` — publications, blog post list, social links
- `app/blog/(posts)/<slug>/page.mdx` — blog posts (MDX with KaTeX math via remark-math/rehype-katex)
- `components/sketches.tsx` — hand-drawn margin illustrations (currently unused)
...
See [EDITING.md](EDITING.md) for how to edit pages and add blog posts, exams,
